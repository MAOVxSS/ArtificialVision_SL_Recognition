import cv2
import os
from Utils.utils import binarize_img
...
dir = os.path.join(STATIC_DATA_WITH_OUT_P_DIR, "y")  # Cambiar la letra
# Carpeta para las imágenes preprocesadas (binarizadas)
preprocessed_dir = os.path.join(STATIC_DATA_PROCESSED_DIR, "y")  # Cambiar la letra
